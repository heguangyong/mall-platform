      ...
      <div class="home_product">
        ...
        <template v-if="itemStyle == 0">
          <div class="list-wrapper itemA" v-if="list.length > 0">
            ...
            >
              <div class="img-box">
                <img v-if="item.cover" :style="contentStyle" :src="item.cover" alt="" />
                ...
                <div class="hd">
                  <div class="text">
                    <div class="title line2" :style="titleColor">
                      <span v-if="titleShow">{{ item.title }}</span>
                    </div>
                  </div>
                </div>
                <div class="price" >
                  <div v-if="timeShow" class="num">
          ...
          <div class="list-wrapper itemA" v-else>
            <div class="item" :style="{ marginBottom: contentConfig + 'px' }">
              ...
              <div class="info">
                ...
                <div class="price">
                  <div v-if="timeShow" class="num"><span>{{ item.createTime }}</span></div>
                </div>
              </div>
            </div>
            <div class="item" :style="{ marginBottom: contentConfig + 'px' }">
              ...
              <div class="info">
                <div class="hd">
                  <div class="text">
                    <div class="title line2" :style="titleColor">
                      <span v-if="titleShow">{{ item.ttile }}</span>
                    </div>
                  </div>
                </div>
                <div class="price">
