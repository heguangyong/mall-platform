  ...
  <div v-if="configObj">
    <div :style="boxStyle" class="mobile-page paddingBox">
      <div class="home_product">
        ...
        <!-- 三列 -->
        <template>
          <div class="advertItem04 acea-row">

            <div class="item pic-four">
              <div class="pic">
                <img :src="list.length > 1 && list[1].cover" v-if="list.length > 1 && list[1].cover"
                  :class="list[1].radioVal === '0' ? 'stretch' : list[1].radioVal === '1' ? 'scale' : 'fill'"
                  class="img-style"  />
                <div class="empty-box" v-else>
                  <span class="iconfont icontupian"></span>
                </div>
                <p class="title-box">{{list[1].title}}</p>
              </div>
              <div class="pic">
                <img :src="list.length > 2 && list[2].cover" v-if="list.length > 2 && list[2].cover"
                  :class="list[2].radioVal === '0' ? 'stretch' : list[2].radioVal === '1' ? 'scale' : 'fill'"
                  class="img-style"  />
                <div class="empty-box" v-else>
                  <span class="iconfont icontupian"></span>
                </div>
                <p class="title-box">{{list[2].title}}</p>
              </div>
            </div>
            <div class="item" :style="spaceStyleTwo">
              <img :src="list.length > 0 && list[0].cover" v-if="list.length > 0 && list[0].cover"
                :class="list[0].radioVal === '0' ? 'stretch' : list[0].radioVal === '1' ? 'scale' : 'fill'"
                class="img-style img-left"  />
              <div class="empty-box" v-else>
                <span class="iconfont icontupian"></span>
              </div>
              <p class="title-box">{{list[0].title}}</p>
            </div>
          </div>
        </template>
      </div>
