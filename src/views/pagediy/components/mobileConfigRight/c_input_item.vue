    ...
    <div class="c_row-item">
      ...
      <div class="slider-box ml22">
        <div @click="getLink(configData.title)">
          <el-input size="small" icon="ios-arrow-forward"
            :icon="configData.title === '链接' || configData.title === '更多链接' ? 'ios-arrow-forward' : ''"
            :readonly="configData.title === '链接' || configData.title === '更多链接' ? true : false" v-model="configData.val"
            :placeholder="configData.place" :maxlength="configData.max">
            <el-button v-if="configData.title === '链接' || configData.title === '更多链接'" slot="append"
