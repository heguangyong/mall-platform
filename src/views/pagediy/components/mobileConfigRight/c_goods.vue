  ...
  export default {
    ...
    methods: {
      ...
      addGoods() {
        ...
        if (this.configObj.name == "ticketRecomm") {
          this.$modalticketList(
            function(row) {
        ...
        if (this.configObj.name == "giftRecomm") {
          this.$modalGiftList(
            function(row) {
              _this.listLoading = false;
        ...
        if (this.configObj.name == "canteenRecomm") {
          this.$modalCanteenList(
            function(row) {
              _this.listLoading = false;
        ...
        if (this.configObj.name == "hotGuide") {
          this.$modalHotguideList(
            function(row) {
              _this.listLoading = false;
        ...
        if (this.configObj.name == "scenicSpots") {
          this.$modalScenicList(
            function(row) {
              _this.listLoading = false;
        ...
        if (this.configObj.name == "newsRecomm") {
          this.$modalNewsRecommList(
            function(row) {
              _this.listLoading = false;
